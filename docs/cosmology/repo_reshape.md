...
| **M0.5** ✅ `e310e125` (2026-09-06; 185 fixtures, 46 pairs; the four excluded theories are #547) | **freeze the oracle** — run legacy across the example corpus and commit the outputs. **Before any porting begins** | fixtures committed and reproducible | — |
